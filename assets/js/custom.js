$(function () {
    ...
    var teamMember1 = '<div class="p-2 vct-team-member-block"> <div class="row mb-3"> <div class="col-4 vct-team-member-name font-weight-normal"> <label for="employees">employee name</label> <input class="w-100" id="employees" placeholder="enter name" /> </div> <div class="col-4 vct-team-member-name font-weight-normal"> <label for="employees">position</label> <input class="w-100" id="position" placeholder="find position" /> </div> <div class="col-4"> <div class="d-flex align-items-end justify-content-end h-100"> <button class="btn ti-close remove-team-member1" data-toggle="tooltip" data-placement="top" title="Remove Team Member"></button> </div> </div> </div> </div>';
